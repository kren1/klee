...
// RUN: %klee --output-dir=%t.klee-out -exit-on-error-type=All -solver-optimize-divides=true %t.bc
// RUN: rm -rf %t.klee-out
// RUN: %klee --output-dir=%t.klee-out -exit-on-error-type=All -solver-optimize-divides=false %t.bc
