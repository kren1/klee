...
// RUN: %klee --output-dir=%t.klee-out --libc=klee --max-forks=25 --no-output --exit-on-error-type=All --optimize --disable-inlining --search=nurs:depth --use-cex-cache %t1.bc
