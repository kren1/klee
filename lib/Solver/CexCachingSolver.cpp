...
public:
  ...
  assignmentsTable.insert(binding);
  selectSMT = binding;
  std::vector<std::vector<unsigned char>> packet_seed_stat = {{
   0x03, 0xfc, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
   0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa4, 0x81, 0x00, 0x00, 'A' , '*' , 0x00, 0x00, 
   0xe1, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
   0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  // const std::vector<unsigned char> packet_seed = 
     {
//     0xd4, 0xc3, 0xb2, 0xa1, //magic
////     0xc3, 0xd4, 0xa1, 0xb2, //magic
//     0x02, 0x00, //version major
//     0x04, 0x00, //version minor
//     0x00, 0x00, 0x00, 0x00, //thiszone
//     0x00, 0x00, 0x00, 0x00, //sigfigs 
//     0x00, 0x00, 0x04, 0x00, //snaplen
//     //0x01, 0x00, 0x00, 0x00, //snaplen
//     0x01, 0x00, 0x00, 0x00, 0xed, 0xf4, 0x42, 0x5d, 0x74, 0x3c, 0x09, 0x00,
//     0x3c, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00, 0x01, 0x00, 0x5e, 0x00, 0x00, 0x12, 0x00, 0x00,
//     0x5e, 0x00, 0x01, 0x00, 0x08, 0x00, 0x45, 0xc0, 0x00, 0x28, 0x08, 0xe2, 0x00, 0x00, 0xff, 0x70,
//     0x23, 0x0a, 0x92, 0xa9, 0x1b, 0xfe, 0xe0, 0x00, 0x00, 0x12, 0x21, 0x00, 0x69, 0x01, 0x00, 0x01,
//     0xcb, 0x52, 0x92, 0xa9, 0x18, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
//     0x00, 0x00, 0x00, 0x00

//       0xa1, 0xb2, 0xc3, 0xd4, //magic 
////       0x02, 0x1F, //version major
////       0x00, 0x00, // versio nminor 
//       0x00, 0x02, //version major
//       0x00, 0x04, //version minor
//       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
//       0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x5d, 0x42, 0xf4, 0xed, 0x00, 0x09, 0x3c, 0x74,
//       0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x5e, 0x00, 0x01, 0x00, 0x00, 0x12, 0x00,
//       0x00, 0x01, 0x00, 0x5e, 0xc0, 0x45, 0x00, 0x08, 0xe2, 0x08, 0x28, 0x00, 0x70, 0xff, 0x00, 0x00,
//       0xa9, 0x92, 0x0a, 0x23, 0x00, 0xe0, 0xfe, 0x1b, 0x00, 0x21, 0x12, 0x00, 0x01, 0x00, 0x01, 0x69,
//       0xa9, 0x92, 0x52, 0xcb, 0x00, 0x00, 0x01, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
//       0x00, 0x00, 0x00, 0x00
         0xd4, 0xc3, 0xb2, 0xa1, 0x02, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00, 0xed, 0xf4, 0x42, 0x5d, 0x74, 0x3c, 0x09, 0x00,
         0x3c, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00, 0x01, 0x00, 0x5e, 0x00, 0x00, 0x12, 0x00, 0x00,
         0x5e, 0x00, 0x01, 0x00, 0x08, 0x00, 0x45, 0xc0, 0x00, 0x28, 0x08, 0xe2, 0x00, 0x00, 0xff, 0x70,
         0x23, 0x0a, 0x92, 0xa9, 0x1b, 0xfe, 0xe0, 0x00, 0x00, 0x12, 0x21, 0x00, 0x69, 0x01, 0x00, 0x01,
         0xcb, 0x52, 0x92, 0xa9, 0x18, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
   ...
   binding = new Assignment (
    {
     cache->CreateArray("A-data-stat", 144),
     cache->CreateArray("A-data", 100), 
     cache->CreateArray("model_version",4)},
     packet_seed_stat);
   assignmentsTable.insert(binding);
   
//binding = new Assignment ({cache->CreateArray("A-data", 100)}, packet_seed);
//   binding = new Assignment ({cache->CreateArray("A-data-stat", 144)}, {packet_seed_stat});
 //  assignmentsTable.insert(binding);
